...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		Intent intentSoundRecord = new Intent(this,SoundRecordActivity.class);
		...
		intentSoundRecord.putExtra(SoundRecordActivity.EXTRA_OUTPUT, soundFile.getPath());
		
		// DONE - Start a new activity for result, using the new intent and the request
		// code MIC_SOUND_REQUEST
		startActivityForResult(intentSoundRecord, MIC_SOUND_REQUEST);
	...
	private void launchCameraIntent() {
		...
		mediaStoreIntent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
